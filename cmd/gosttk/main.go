...
import (
	...
	var ciphmac = flag.Bool("cmac", false, "Compute cipher-based message authentication code.")
	...
	var mac = flag.Bool("hmac", false, "Compute hash-based message authentication code.")
