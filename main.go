...
import (
	...
	var derive = flag.Bool("derive", false, "Derive shared key negociation (VKO GOST R 34.10-2012).")
	...
	var generate = flag.Bool("generate", false, "Generate GOST R 34.10-2012 asymmetric keypair.")
